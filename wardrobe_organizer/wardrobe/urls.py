...
items_urls = [
    ...
    path('<int:item_id>/add_laundry/', views.add_laundry,
         name='add_laundry'),
    path('<int:item_id>/del_laundry/', views.del_laundry,
         name='del_laundry'),
]

outfits_urls = [
    path('create/', views.outfit_create,
         name='outfit_create'),
    path('<int:outfit_id>/', views.outfit_detail,
         name='outfit_detail'),
    path('', views.outfit_list, name='outfit_list'),
    path('<int:outfit_id>/edit/', views.outfit_edit,
         name='outfit_edit'),
    path('<int:outfit_id>/delete/', views.outfit_delete,
         name='outfit_delete'),
    path('<int:outfit_id>/use/', views.outfit_use,
         name='outfit_use'),
